...
namespace Indspire.Soaring.Engagement.Controllers
{
    ...
    using Indspire.Soaring.Engagement.Models.ManageViewModels;
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<IActionResult> Index(IndexViewModel model)
        {
            ...
            return this.RedirectToAction(nameof(ManageController.Index));
        }
        ...
        public async Task<IActionResult> EnableAuthenticator()
        {
            ...
            {
                SharedKey = ManageController.FormatKey(unformattedKey),
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                this.urlEncoder.Encode("Indspire.Soaring.Engagement"),
