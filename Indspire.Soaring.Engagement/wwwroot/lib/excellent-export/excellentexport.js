...
var ExcellentExport = (function() {
    ...
    var version = "1.5.0";
    var uri = { excel: 'data:/vnd.openxmlformats-officedocument.spreadsheetml.sheet;base64,', csv: 'data:application/csv;base64,' };
    ...
    var ee = {
        ...
        excel: function(anchor, table, name) {
            ...
            return createDownloadLink(anchor, b64, 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'export.xls');
        },
        /** @export */
